...
#define A0pin A0
#define SIpin 13    //Start Integration ~ orange
#define CLKpin 12
...
void vision_line_control(int base_speed, double l_c)
{
  ...
  int temp_data=0;
  temp_data =(base_speed - pwm_control_value)*2;
...
void VLC_move(void)  // 비전 라인 컨트롤
{
  ...
  cx_int = (int)cx;
  read_line_camera();
  threshold_line_image(25);  // 값 조정
  cx = line_centroid();
  vision_line_control(60, cx);
...
void loop()
{
  ...
  }//562//597//50//64//1136/1143//1200//1190/
}
