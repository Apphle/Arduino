...
int line_sensor[5] = {  0,  0,  0,  0,  0}; // line_sensor 값 배열을 선언
 ...
 void line_following(int line_index)
 {
  switch(line_index)
  {
    case -4: motor_L_control(-30); motor_R_control(120);
            break;
    case -3: motor_L_control(0); motor_R_control(100);
            break;
    case -2: motor_L_control(30); motor_R_control(80);
            break;
    case -1: motor_L_control(60); motor_R_control(50);
            break;
    case  0: motor_L_control(80);motor_R_control(80);
            break;
    case  1: motor_R_control(60);motor_L_control(50);
            break;
    case  2: motor_R_control(30);motor_L_control(80);
            break;
    case  3: motor_R_control(0);motor_L_control(100);
            break;
    case  4: motor_R_control(-30);motor_L_control(120);
            break;
